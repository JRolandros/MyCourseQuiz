...
public class MyBDD extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE joueur(id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT NOT NULL, password TEXT NOT NULL, pseudo TEXT, latitude Double, longitude Double);");
