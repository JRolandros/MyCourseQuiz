...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private Joueur user;
    //string set if the user odesn't exist and if it's created
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button abandonBtn = (Button) findViewById(R.id.abandon);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                user=dataManager.getJoueur(mEmail);
                if(user.getId()>0){
                    return user.getPassword().equals(mPassword);
                }else{
                    user.setPassword(mPassword);
                    //user=dataManager.insertJoueur(user);
                    userCreatedMessage="Vous etes un nouvel utilisateur, votre a été créé avec les identifiants fournis\npseudo=user\n Penser à le modifier";
                    return true;
                }
                        ...
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                try{
                                    ...
                                    dataManager = new DataManager(mContext);
                                    user=dataManager.insertJoueur(user);
                                    Toast myToast = Toast.makeText(mContext,userCreatedMessage, Toast.LENGTH_SHORT);
                                    myToast.show();
                                    Intent myIntent = new Intent(LoginActivity.this,MainActivity.class);
                                    myIntent.putExtra("loginUser",user);
                                    LoginActivity.this.startActivity(myIntent);
